...
import { Pokemon } from '@vapormall/sim';
...
/*
const menuTexture = PIXI.Texture.WHITE;
const movesTexture = PIXI.Texture.WHITE;
const switchstatsTexture = PIXI.Texture.WHITE;
const messageTexture = PIXI.Texture.WHITE;
*/
