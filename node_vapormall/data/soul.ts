...
const SOUL_LIST = {
    Adware: {
        ...
        types: [CONSTANTS.TYPES.ERROR],
        levelUp: [
            {
                level: 1,
                learnedSkills: [SKILL_LIST.basic_attack, SKILL_LIST.recoil],
            },
            {
                level: 2,
                statChanges: [{ stat: CONSTANTS.STATS.SPEED, change: 6 }],
                learnedSkills: [SKILL_LIST.dazzling_polish],
            },
            {
                level: 3,
                statChanges: [{ stat: CONSTANTS.STATS.DEFENSE, change: 6 }],
            },
            {
                level: 4,
                statChanges: [{ stat: CONSTANTS.STATS.HP, change: 15 }],
                learnedSkills: [SKILL_LIST.drain],
            },
            {
                level: 5,
                statChanges: [
            ...
            {
                level: 8,
                statChanges: [{ stat: CONSTANTS.STATS.HP, change: 20 }],
            },
        ],
    },
};
